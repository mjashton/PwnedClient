...
namespace PwnedClient.Interfaces
{
    public interface IPwnedClient
    {
        ...
        /// <returns></returns>
        int GetBreachCount(string password, bool isHashed = false);
        ...
        /// <returns></returns>
        int GetBreachCountHashedPassword(string hashedPassword);
        ...
        /// <param name="password"></param>
        /// <returns></returns>
        int GetBreachCountPlainTextPassword(string password);
        ...
        /// </remarks>
        Dictionary<string, int> GetMatchesDictionary(string hashedPassword);
        ...
        /// </remarks>
        string GetMatchesRaw(string hashedPassword);
        ...
        /// <param name="isHashed"></param>
        /// <returns></returns>
        bool IsCompromised(string password, bool isHashed = false);
        ...
        bool IsCompromisedHashedPassword(string hashedPassword);
        ...
        /// <param name="password"></param>
        /// <returns>true/false</returns>
        bool IsCompromisedPlainTextPassword(string password);
    }
}